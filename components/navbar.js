            ...
            <>
              <div className="flex flex-wrap justify-between md:flex-nowrap md:gap-10">
                ...
                <div className="flex w-full items-center justify-between md:w-auto">
                  <Link href="/" className="w-28 dark:hidden">
                    {props.logo ? (
                      ...
                      <span className="block text-center">
                        <div className="h-18 w-18 relative  flex-shrink-0">
                          <img
                            className="rounded-full object-cover"
                            src="https://firebasestorage.googleapis.com/v0/b/blog-ca662.appspot.com/o/perfil.jpg?alt=media&token=42a2a5d7-f5b6-4b9b-b511-8b04b699354d"></img>
                        </div>
                  ...
                  <div className="ml-10">
                    <ThemeSwitch className="mx-auto block  md:ml-20 md:hidden" />
                  </div>
                  <Disclosure.Button
